...
# Deploys Azure infrastructure, application code, AND GenAI services

set -e

echo "=========================================="
echo "Expense Management System Deployment"
echo "WITH GenAI Services for Chat UI"
echo "=========================================="
...
echo ""
echo "Step 2: Deploying Azure infrastructure (including GenAI)..."
...
echo "      The Chat UI is fully functional with GenAI services"
echo ""
